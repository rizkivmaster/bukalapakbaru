...
import bukalapak.view.draft.DraftUploadFragment;
import bukalapak.view.lapak.available.LapakDijualFragment;
import bukalapak.view.lapak.sold.LapakTidakDijualFragment;
import bukalapak.view.login.LoginActivity;
import bukalapak.view.message.inbox.PesanFragment;
import bukalapak.view.negotiation.NegotiationFragment;
import bukalapak.view.profile.ProfilFragment;
import bukalapak.view.transaction.TransactionsFragment;
...
public class MenuFragment extends ListFragment {
		...
		if (!items.get(position).isSection()) {
			 ...
			 */if ((item.title).equals("Lapak Dijual")) {
				...
				ProfileManager manager = new ProfileManager(
						CredentialEditor.loadCredential(context));
				manager.delete();
	...
	private void switchFragment(Fragment fragment, int pos) {
		...
		if (getActivity() instanceof MainWindowActivity) {
			MainWindowActivity ra = (MainWindowActivity) getActivity();
			// String[] list_menu =
			// getResources().getStringArray(R.array.slide_menu);
