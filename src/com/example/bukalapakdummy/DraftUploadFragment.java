...
public class DraftUploadFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		LinearLayout gv = (LinearLayout) inflater.inflate(R.layout.draft_list, null);
		
		ListView list = (ListView) gv.findViewById(R.id.draft_list);
		
		ArrayList<DraftedLocalProduct> d = UploadProductEditor.listDraftedProduct(credential);
		DraftUploadItem adapter = new DraftUploadItem(d, context);
